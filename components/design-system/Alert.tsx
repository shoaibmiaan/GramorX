...
export const Alert: React.FC<{
  ...
  const IconInfo = (p: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 24 24" aria-hidden="true" {...p}>
      <path
        fill="currentColor"
        d="M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20Zm.75 6.75a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0ZM11 10h2v7h-2z"
      />
    </svg>
  );
  const IconCheck = (p: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 24 24" aria-hidden="true" {...p}>
      <path
        fill="currentColor"
        d="M12 2a10 10 0 1 0 10 10A10.011 10.011 0 0 0 12 2m-1.1 13.7-3.6-3.6 1.4-1.4 2.2 2.2 4.7-4.7 1.4 1.4z"
      />
    </svg>
  );
  ...
  const IconError = (p: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 24 24" aria-hidden="true" {...p}>
      <path
        fill="currentColor"
        d="M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20Zm3.5 12.09-1.41 1.41L12 13.41l-2.09 2.09-1.41-1.41L10.59 12 8.5 9.91l1.41-1.41L12 10.59l2.09-2.09 1.41 1.41L13.41 12z"
      />
    </svg>
  );
  ...
  /** Explicit token classes for Tailwind JIT */
  ...
  const defaultIcon =
    variant === "success" ? (
      ...
      <IconWarn className="h-5 w-5 sm:h-6 sm:w-6" />
    ) : variant === "error" ? (
      <IconError className="h-5 w-5 sm:h-6 sm:w-6" />
    ) : (
  ...
  return (
    <div
      ...
      aria-atomic="true"
      className={cx(
        "card-surface border rounded-ds-2xl",
