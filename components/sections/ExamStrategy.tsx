// components/sections/ExamStrategy.tsx
      ...
      <Container>
        <div className="flex items-end justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground mt-1">A simple path: learn key strategies → practise each module → get AI feedback → re‑evaluate & improve.</p>
          </div>
        ...
        <div className="mt-6 grid gap-6 lg:grid-cols-3">
          <Card className="card-surface p-6 rounded-ds-2xl">
            ...
            <div className="mt-5 flex gap-3">
              <Button href="/learning/strategies?area=all" variant="secondary" className="rounded-ds-xl">Read strategies</Button>
            </div>
          </Card>
        ...
        <div className="mt-6 grid gap-3 sm:grid-cols-4">
          {[
            ...
            <NavLink key={x.href} href={x.href} className="p-3.5 rounded-ds border border-border hover:bg-electricBlue/5 transition">
