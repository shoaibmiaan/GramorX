      ...
      <Container>
        <div className="min-h-[100svh] grid place-items-center">
          <Card className="w-full max-w-md p-8 rounded-ds-2xl">
            ...
            <h1 className="font-slab text-h1 mb-2 text-primary dark:text-electricBlue">Sign in with Email</h1>
            <p className="text-grayish dark:text-white/75 mb-6">Enter your credentials to continue.</p>

            {err && <Alert variant="error" title="Login failed" className="mb-4">{err}</Alert>}
            ...
            <form onSubmit={submit} className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <a href="/forgot-password" className="text-small text-primary dark:text-electricBlue font-semibold">Forgot password?</a>
              </div>
